...
**Face Stickers** is an app that allows users to use gestures in order to create fun pictures using a variety of images.
...
1. How to programatically autocontraint rules.
...
I had to use trial and error to determine the correct size and offset for the tray so that it does not interfere with the iphone x homebar.
